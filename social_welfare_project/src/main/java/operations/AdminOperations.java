...
//            activity.setCreatedBy(createdBy);
 ...
 private void addCertification() {
        ...
        // Create dummy User and VolunteerActivity for the example
        User user = new User();
        user.setUserId(1); // Assume you have a User with ID 1 for simplicity

        VolunteerActivity activity = new VolunteerActivity();
        activity.setActivityId(1); // Assume you have a VolunteerActivity with ID 1 for simplicity
